        ...
        <div className="absolute inset-0 flex items-center justify-center z-10">
          <div className="text-center max-w-4xl mx-auto px-4">
            <div className="flex items-center justify-center mb-4 animate-scale-in">
              ...
              <h1 className="text-5xl md:text-7xl font-serif font-bold text-white mb-12 animate-elegant-fade bg-gradient-to-r from-white via-jimdar-light to-white bg-clip-text text-transparent">
                JIMDAR Elite
              </h1>
              <Gem className="h-8 w-8 text-yellow-400 ml-3 animate-bounce delay-500" />
            </div>
            <p className="text-xl md:text-2xl text-jimdar-light mb-8 animate-slide-in-right">
              Discover luxury fashion that defines your elite status
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center animate-stagger-in">
              <Link
                to="/categories"
      ...
      <section className="py-16 bg-jimdar-dark relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="group text-center p-8 bg-gradient-to-br from-jimdar-darker to-jimdar-blue/20 rounded-xl hover:from-jimdar-blue/30 hover:to-jimdar-darker transition-all duration-500 transform hover:-translate-y-2 hover:shadow-2xl border border-jimdar-blue/20 animate-stagger-in animate-stagger-1">
              <div className="w-20 h-20 bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg animate-smooth-scale">
            ...
            <div className="group text-center p-8 bg-gradient-to-br from-jimdar-darker to-jimdar-blue/20 rounded-xl hover:from-jimdar-blue/30 hover:to-jimdar-darker transition-all duration-500 transform hover:-translate-y-2 hover:shadow-2xl border border-jimdar-blue/20 animate-stagger-in animate-stagger-2">
              <div className="w-20 h-20 bg-gradient-to-br from-green-400 to-green-600 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg animate-smooth-scale">
            ...
            <div className="group text-center p-8 bg-gradient-to-br from-jimdar-darker to-jimdar-blue/20 rounded-xl hover:from-jimdar-blue/30 hover:to-jimdar-darker transition-all duration-500 transform hover:-translate-y-2 hover:shadow-2xl border border-jimdar-blue/20 animate-stagger-in animate-stagger-3">
              <div className="w-20 h-20 bg-gradient-to-br from-blue-400 to-blue-600 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg animate-smooth-scale">
