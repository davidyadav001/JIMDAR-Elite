    ...
    <div className="group relative bg-jimdar-darker rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
        ...
        <div className="flex items-center justify-between relative z-20">
          ...
          <div className="flex space-x-2">
            <button
              ...
              className="p-2 bg-jimdar-blue text-white rounded-full hover:bg-jimdar-light hover:text-jimdar-darker transition-all duration-200 transform hover:scale-110 cursor-pointer relative z-30"
              title="Add to Cart"
            >
            ...
            <button
              ...
              className={`p-2 rounded-full transition-all duration-200 transform hover:scale-110 cursor-pointer relative z-30 ${
      ...
      <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-30 transition-all duration-300 flex items-center justify-center opacity-0 group-hover:opacity-100 pointer-events-none">
        <Link
          ...
          className="p-3 bg-white bg-opacity-90 text-jimdar-darker rounded-full hover:bg-opacity-100 transition-all duration-200 transform hover:scale-110 pointer-events-auto"
        >
